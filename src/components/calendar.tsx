    ...
    <DayPicker
      ...
      classNames={{
        ...
        [SelectionState.selected]:
          'bg-green-200 text-primary-foreground hover:bg-green-200 hover:text-primary-foreground focus:bg-green-200 focus:text-primary-foreground',
        [SelectionState.range_middle]:
          'aria-selected:bg-accent aria-selected:text-accent-foreground',
        [DayFlag.today]: 'bg-green-100 text-accent-foreground aria-selected:bg-green-200',
        [DayFlag.outside]:
...
function Chevron({ orientation = "left", ...props }) {
  switch (orientation) {
      case "left":
          return <FiChevronLeft className="h-4 w-4" />;
      case "right":
